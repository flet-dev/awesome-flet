...
|-------------------|-----------------------------------------------------------------------------------------------------------------------------|-----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|
| Co-Tower          | Desktop companion for monitoring GitHub Copilot tasks, seat usage, and organization events.                                 | Windows · Linux | [Microsoft Store](https://apps.microsoft.com/detail/9nl06gx6j83p) · [Snap Store](https://snapcraft.io/co-tower)                                                              | -                                               |
...
| Graph Agent UI    | Desktop client for connecting to, visualizing, and running LangGraph workflows.                                             | Windows · Linux | [Microsoft Store](https://apps.microsoft.com/detail/9nj7pxq9nvn8) · [Snap Store](https://snapcraft.io/graph-agent-ui)                                                        | -                                               |
