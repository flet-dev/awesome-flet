...
|-------------------|-----------------------------------------------------------------------------------------------------------------------------|-------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| Co-Tower          | Collaborative tower-building application for desktop platforms.                                                             | Windows · macOS · Linux | [Store](https://etz-hadaat.github.io/Co-Tower/)                                                                                                                              | [GitHub](https://github.com/etz-hadaat/Co-Tower)          |
...
| Graph Agent UI    | Graph-based user interface for working with AI agents on desktop platforms.                                                 | Windows · macOS · Linux | [Store](https://etz-hadaat.github.io/Graph-Agent-UI-v2/)                                                                                                                     | [GitHub](https://github.com/etz-hadaat/Graph-Agent-UI-v2) |
